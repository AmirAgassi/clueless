...
export function getPersonPropertiesHash(distinct_id, userPropertiesToSet, userPropertiesToSetOnce) {
    return jsonStringify({ distinct_id: distinct_id, userPropertiesToSet: userPropertiesToSet, userPropertiesToSetOnce: userPropertiesToSetOnce });
}
export var propertyComparisons = {
    ...
    regex: function (targets, values) { return values.some(function (value) { return targets.some(function (target) { return isMatchingRegex(value, target); }); }); },
    not_regex: function (targets, values) { return values.every(function (value) { return targets.every(function (target) { return !isMatchingRegex(value, target); }); }); },
...
//# sourceMappingURL=property-utils.js.ma