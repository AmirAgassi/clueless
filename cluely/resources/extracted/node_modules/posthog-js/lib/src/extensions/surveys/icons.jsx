}export var satisfiedEmoji = (<svg className="emoji-svg" xmlns="http://www.w3.org/2000/svg" height="48" viewBox="0 -960 960 960" width="48">
...
export var neutralEmoji = (<svg className="emoji-svg" xmlns="http://www.w3.org/2000/svg" height="48" viewBox="0 -960 960 960" width="48">
...
export var dissatisfiedEmoji = (<svg className="emoji-svg" xmlns="http://www.w3.org/2000/svg" height="48" viewBox="0 -960 960 960" width="48">
...
export var veryDissatisfiedEmoji = (<svg className="emoji-svg" xmlns="http://www.w3.org/2000/svg" height="48" viewBox="0 -960 960 960" width="48">
...
export var verySatisfiedEmoji = (<svg className="emoji-svg" xmlns="http://www.w3.org/2000/svg" height="48" viewBox="0 -960 960 960" width="48">
...
export var cancelSVG = (<svg width="12" height="12" viewBox="0 0 12 12" fill="none" xmlns="http://www.w3.org/2000/svg">
...
export var IconPosthogLogo = (<svg width="77" height="14" viewBox="0 0 77 14" fill="none" xmlns="http://www.w3.org/2000/svg">
        <g clip-path="url(#clip0_2415_6911)">
            <mask id="mask0_2415_6911" style={{ maskType: 'luminance' }} maskUnits="userSpaceOnUse" x="0" y="0" width="77" height="14">
...
export var checkSVG = (<svg width="16" height="12" viewBox="0 0 16 12" fill="none" xmlns="http://www.w3.org/2000/svg">
