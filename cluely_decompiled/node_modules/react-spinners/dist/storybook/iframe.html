...
<html lang="en">
  <head>
    ...
    <script>
      ...
      window.STORIES = [{"titlePrefix":"","directory":"./stories","files":"*.stories.@(ts|tsx)","importPathMatcher":"^\\.[\\\\/](?:stories\\/(?!\\.)(?=.)[^/]*?\\.stories\\.(ts|tsx))$"}];
...
<script>
  ...
  try {
    ...
    <script type="module" crossorigin src="./assets/iframe-5p6UzXUn.js"></script>
  </head>
