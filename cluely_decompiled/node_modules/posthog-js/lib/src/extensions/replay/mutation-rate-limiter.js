...
var MutationRateLimiter = /** @class */ (function () {
    function MutationRateLimiter(_rrweb, _options) {
        ...
        this._refillRate = 10;
        this._mutationBuckets = {};
        this._loggedTracker = {};
        this._refillBuckets = function () {
            Object.keys(_this._mutationBuckets).forEach(function (key) {
                _this._mutationBuckets[key] = _this._mutationBuckets[key] + _this._refillRate;
                if (_this._mutationBuckets[key] >= _this._bucketSize) {
                    delete _this._mutationBuckets[key];
                }
            });
        };
        this._getNodeOrRelevantParent = function (id) {
            ...
            var node = _this._rrweb.mirror.getNode(id);
        ...
        this.throttleMutations = function (event) {
            ...
            if (data.attributes) {
                ...
                data.attributes = data.attributes.filter(function (attr) {
                    var _a, _b, _c;
                    var _d = __read(_this._getNodeOrRelevantParent(attr.id), 2), nodeId = _d[0], node = _d[1];
                    if (_this._mutationBuckets[nodeId] === 0) {
                        return false;
                    }
                    _this._mutationBuckets[nodeId] = (_a = _this._mutationBuckets[nodeId]) !== null && _a !== void 0 ? _a : _this._bucketSize;
                    _this._mutationBuckets[nodeId] = Math.max(_this._mutationBuckets[nodeId] - 1, 0);
                    if (_this._mutationBuckets[nodeId] === 0) {
                        if (!_this._loggedTracker[nodeId]) {
                            _this._loggedTracker[nodeId] = true;
                            (_c = (_b = _this._options).onBlockedNode) === null || _c === void 0 ? void 0 : _c.call(_b, nodeId, node);
                        }
                    }
                    return attr;
                });
        ...
        this._refillRate = clampToRange((_a = this._options.refillRate) !== null && _a !== void 0 ? _a : this._refillRate, 0, 100, 'mutation throttling refill rate');
        this._bucketSize = clampToRange((_b = this._options.bucketSize) !== null && _b !== void 0 ? _b : this._bucketSize, 0, 100, 'mutation throttling bucket size');
...
//# sourceMappingURL=mutation-rate-limiter.js.ma